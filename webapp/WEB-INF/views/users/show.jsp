...
<div class="tab-content">
    <div class="row-fluid tab-pane active" role="tabpanel" id="userInfo">
        <div class="col-md-12">
            ...
            <br>
            <a href="<c:url value="/users/${user.id}/edit"/>" class="btn btn-info">编辑</a>
            <a href="<c:url value="/users/${user.id}/reset_password"/>" class="btn btn-primary">重置密码</a>
            <a href="<c:url value="/users/${user.id}"/>" class="btn btn-danger" data-method="DELETE" data-remote="true"
    ...
    <div class="row-fluid tab-pane" role="tabpanel" id="roleList">
        <div class="col-md-12">
            ...
            <a class="btn btn-primary" href="/users/${user.id}/edit_roles">修改角色</a>
        </div>
    </div>
</div>
