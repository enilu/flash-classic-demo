...
<div class="row-fluid clearfix">
    <div class="pull-right">
        <a class="btn btn-primary" href="<c:url value="/system/permissions/new"/>">创建权限</a>
    </div>
</div>
<div class="row-fluid">
    <form:form action="/system/permissions" method="GET"
...
<display:table name="permissions.data" id="permission_" class="table table-striped table-bordered">
    ...
    <display:column title="权限标识名">
        <a href="/system/permissions/${permission_.id}">${permission_.name}</a>
    </display:column>
    <display:column property="description" title="备注"/>
    <display:column title="创建时间">
        <joda:format value="${permission_.createdAt}" pattern="yyyy-MM-dd hh:mm:ss"/>
    </display:column>
</display:table>
