...
<div class="row-fluid clearfix">
	...
	<a class="btn btn-primary pull-right" href="/system/roles/${role.id}/edit_permissions">修改权限</a>
</div>
...
<a href="<c:url value="/system/roles/${role.id}/edit"/>" class="btn btn-info">编辑</a>
<a href="<c:url value="/system/roles/${role.id}"/>" class="btn btn-danger" data-method="DELETE" data-remote="true" data-redirect="<c:url value="/roles"/>">删除</a>
