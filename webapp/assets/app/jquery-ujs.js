// this is copied from http://github.com/rails/jquery-ujs/
jQuery(function ($) {
    ...
    $.fn.extend({
        ...
        callRemote: function () {
            var el      = this,
                ...
                dataType  = el.attr('data-type')  || 'json';
    ...
    $('a[data-method]:not(a[data-remote])').on('click', function (e){
        var link = $(this),
            href = link.attr('href'),
    ...
    var disable_with_form_not_remote_selector = 'form:not(form[data-remote]):has(' + disable_with_input_selector + ')';
